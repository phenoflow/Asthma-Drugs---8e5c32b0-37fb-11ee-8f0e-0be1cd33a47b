...
codes = [{"code":"12144","system":"gprdproduct"},{"code":"13575","system":"gprdproduct"},{"code":"15153","system":"gprdproduct"},{"code":"26860","system":"gprdproduct"},{"code":"2911","system":"gprdproduct"}];
REQUIRED_CODES = 1;
